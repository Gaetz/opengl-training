...
void Scene_004_PassingData::load() {
    ...
    ResourceManager::loadShader("assets/shaders/004_tessellation.vert", "assets/shaders/004_tessellation.frag", "", "", "", "004_tessellation");
    shader = ResourceManager::getShader("004_tessellation");
